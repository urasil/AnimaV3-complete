...
def make_exe():
    ...
    #dist = PythonDistribution(url='https://github.com/indygreg/python-build-standalone/releases/download/20220318/cpython-3.9.11+20220318-x86_64-apple-darwin-install_only.tar.gz')
    ...
    # Run a Python file when the interpreter starts.command
    ...
    # attributes.
    for resource in exe.pip_install(["ffmpeg"]):
    ...
    # context.
    # exe.add_python_resources(exe.read_virtualenv(path="/Users/ARCK/miniconda3/envs/animaNew"))
